...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edLogin = (EditText) findViewById(R.id.edtLoginAutenticacao);
        edPass = (EditText) findViewById(R.id.edtSenhaAutenticacao);
        btLogin = (Button) findViewById(R.id.btnEntrarAutenticacao);
